...
public class ExtentReportManager implements ITestListener {
    ...
    public void onStart(ITestContext testContext) {
		...
		*/
        ...
        sparkReporter.config().setDocumentTitle("Sandbox CloudEagle Automation Report"); // Title of report
        sparkReporter.config().setReportName("Sandbox CloudEagle Testing"); // name of the report
        sparkReporter.config().setTheme(Theme.DARK);

        extent = new ExtentReports();
        extent.attachReporter(sparkReporter);
        extent.setSystemInfo("Application", "sandbox");
        extent.setSystemInfo("Company Name", "CloudEagle");
        extent.setSystemInfo("Tester Name", "Sayantan Mukherjee");
        extent.setSystemInfo("Module", "Support");
